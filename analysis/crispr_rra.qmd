...
```{r echo=FALSE}
rraS87[hitlist[, .(Gene = gene_name)], on = "Gene"][order(rankscore)] %>% DT::datatable() %>% DT::formatRound("FDR", digits = 5)

```

```{r plot-venn, fig.height=4, fig.width=4, message=FALSE, warning=FALSE, include=FALSE}

...
- Did CRISPR screen analysis using custom RRA method [link](analysis/crispr_rra.qmd)
- Respond to comments on ATAC QC [link](analysis/atac_QC_comments.qmd)
- Updated interaction computation and made some comparisons with previous results. [link](analysis/compare_interaction_files.qmd)
- Run interaction computation on 100kb upstream of TSS (per reviewer comment), [link](analysis/Expand_GeneRegion_for_NetworkAnalysis.qmd)
- [genometrakcs](analysis/genometracks.qmd)
...
-   Regarding libary QC, see google doc [section](https://docs.google.com/document/d/1m4bml55GpEqOuePVW7lyhkZZgy6DNjqOX4Aq9iGc9tE/edit#bookmark=id.drfri2pwzln8)
    ...
    -   See Library summary [LINK](analysis/QC-v2.qmd)
